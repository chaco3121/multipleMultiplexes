...
CREATE TABLE SHOW_TIMINGS("ID" INTEGER not null primary key, "DAY" INTEGER not null, "THEATER_ID" INTEGER not null, "MOVIE_ID" INTEGER not null, "TIMESLOT_ID" INTEGER not null, "MULTIPLEX_ID" VARCHAR(50) not null)
...
CREATE TABLE MULTIPLEXES("ID" VARCHAR(50) not null primary key, "CITY" VARCHAR(50) not null)
...
ALTER TABLE SHOW_TIMINGS ADD CONSTRAINT SHOW_MULTIPLEX_FK FOREIGN KEY ("MULTIPLEX_ID") REFERENCES MULTIPLEXES ("ID")
